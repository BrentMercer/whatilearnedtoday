...
async function loadFacts() {
  const res = await fetch(
    "https://jmobklayagsovcyskhfh.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imptb2JrbGF5YWdzb3ZjeXNraGZoIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTc1NzU1MDQsImV4cCI6MjAxMzE1MTUwNH0.iSi913yNv8RQYtBZG5VfbNWLx2dEzqVgzQBZ-5A2a8A",
      },
    }
  );
